...
|---|---|---:|---:|---|
| P1 | IRLZ44N MOSFET | 10 | 8-12 | Logic-level MOSFET, Infineon or Vishay preferred |
| P1 | Resistor Assortment Kit | 1 | 5-10 | Include 47R, 100R, 220R, 1k, 10k, 22k, 47k |
| P1 | 1N4007 Diode | 20 | 2-4 | General-purpose rectifier diode |
| P1 | 1N5819 Schottky Diode | 10 | 3-5 | For Buck and Boost converter labs |
| P1 | 100 nF Ceramic Capacitors | 20 | 1-2 | X7R ceramic capacitors |
| P1 | 100 uF Electrolytic Capacitors | 10 | 3-5 | Low ESR preferred |
| P1 | 220 uF Electrolytic Capacitors | 5 | 2-3 | 25 V to 50 V rating |
| P1 | 470 uF Electrolytic Capacitors | 5 | 3-5 | DC-link and smoothing work |
| P1 | 100 uH Inductor | 5 | 5-10 | Power inductor for Buck and Boost converters |
| P2 | 10 uF Electrolytic Capacitors | 5 | 1-2 | 25 V to 50 V rating preferred |
...
| P3 | IR2104 Gate Driver | 2 | 8-12 | Half-bridge driver modules |
| P3 | ACS712 Current Sensor | 1-2 | 6-10 | 5 A version recommended for training work |
| P3 | 1 mH Inductor | 2 | 4-8 | L-filter inductor for VSC projects |
| P3 | 1 uF Film Capacitors | 5 | 3-6 | Polypropylene film capacitor preferred |
| P4 | IR2110 Gate Driver | 1-2 | 6-12 | Advanced alternative to IR2104 |
| P4 | ACS758 Current Sensor | 1 | 10-20 | Higher current capability than ACS712 |
| P4 | Standalone Function Generator | 1 | 60-120 | Optional because OWON HDS272S already includes one |
...
- Reduce IR2104 quantity to 2 unless you specifically want extra spares.
- Reduce ACS712 quantity to 1 or 2 depending on whether you want a spare.
...
- IR2110
- ACS758
- optional spare controllers and optional standalone generator
